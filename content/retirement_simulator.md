...
> Linear Planning → How does my account grow and change over time based on fixed inputs?
...
> Probabilistic – Stress Testing Against Unknown Unknowns 
...
- **Created visualization tools** – Selectable via dropdown for real vs nominal values and percentile carried forward for decumulation visualization.
---
